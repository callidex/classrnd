...
#pragma warning restore 0219
        ...
        private Expression ParseIdentifier()
        {
            ...
            if (keywords.TryGetValue(token.text, out value))
            {
                ...
                if (keywordIt != null && (value != null && value.ToString() == keywordIt)) return ParseIt();
                if (value != null && (keywordIif != null && value.ToString() == keywordIif)) return ParseIif();
                if (value != null && (keywordNew != null && value.ToString() == keywordNew)) return ParseNew();
                NextToken();
